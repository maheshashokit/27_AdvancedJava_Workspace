...
public class StudentInsertWithScannerAndSequenceDemo {
		  ...
		  Connection con = DriverManager.getConnection("jdbc:oracle:thin:@localhost:1521:xe", "system","manager");
		    ...
		    if(con != null) {
		    	...
		    	try(
		    		...
		    		String insertQuery = "insert into ashokit_students values(ashokit_students_seq.nextval"+",'"+studentName+"','"+studentLocation+"','"+contactNo+"')";
